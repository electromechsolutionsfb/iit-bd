...
export const noticesData = [
  {
    id: 1,
    title: "New Batch Admission Open - Spring 2026",
    date: "Feb 15, 2026",
    tag: "Admission",
  ...
  {
    id: 2,
    title: "Industrial Safety Workshop Schedule",
    date: "Feb 12, 2026",
    tag: "Workshop",
    desc: "A mandatory workshop on industrial safety protocols for all current students.",
    details: "A comprehensive workshop focusing on OSHA standards...",
    pdfUrl: "https://eforms.state.gov/Forms/ds10.PDF",
  },
  {
    id: 3,
    title: "Class Schedule Update - Evening Batch",
    date: "Feb 10, 2026",
    tag: "Updates",
    desc: "Minor changes have been made to the class timing for the Evening Industrial Automation batch.",
    details: "Due to administrative updates, the evening batch classes...",
    pdfUrl: "https://eforms.state.gov/Forms/ds10.PDF",
  },
  {
    id: 4,
